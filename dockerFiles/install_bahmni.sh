...
# if [[ -f "/${container_name}/letsencrypt-certs/cert.crt" && -f "/${container_name}/letsencrypt-certs/chained.pem" && -f "/${container_name}/letsencrypt-certs/domain.key" ]] &&      "/${container_name}/letsencrypt-certs/chained.pem" ;
# then
	# echo "inside if" ;
